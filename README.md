...
서울 기반 · 웹 디자인 · 인터랙티브 개발 · 브랜딩

<br />

[![Portfolio](https://img.shields.io/badge/Portfolio-alephstudio.site-000000?style=for-the-badge&logo=googlechrome&logoColor=white)](https://alephstudio.site/)
[![Studio](https://img.shields.io/badge/Studio-alephstudio.art-111111?style=for-the-badge&logo=firefox&logoColor=white)](https://alephstudio.art/)
[![Email](https://img.shields.io/badge/Email-info@alephstudio.art-222222?style=for-the-badge&logo=gmail&logoColor=white)](mailto:info@alephstudio.art)
[![Instagram](https://img.shields.io/badge/Instagram-@alephstudio-333333?style=for-the-badge&logo=instagram&logoColor=white)](https://www.instagram.com/alephstudio)
...
**ALEPHSTUDIO**는 브랜드의 철학을 몰입도 높은 디지털 경험으로 구현하는 크리에이티브 웹 스튜디오입니다.  
웹 디자인, 프론트엔드 퍼블리싱, 백엔드 개발을 결합해 **미적으로 세련되고 기술적으로 신뢰할 수 있는** 웹사이트를 만듭니다.

> *ALEPHSTUDIO is a creative web studio that translates brand philosophy into immersive digital experiences. Combining web design, front-end publishing, and back-end development, we deliver websites that are aesthetically refined and technically reliable.*

사용자의 맥락을 이해하고, 유연한 디자인과 엔지니어링으로 **지속 가능한 디지털 생태계**를 설계합니다.

| | |
|:---:|:---|
| **Location** | Seoul, Republic of Korea · Global |
| **Focus** | Web Design · Development · Branding · Strategy |
| **Services** | Homepage · Interactive Web · UI/UX · Responsive · Publishing |
...
- **홈페이지 제작** — 맞춤형 웹사이트 설계·개발
- **인터랙티브 웹** — Three.js, 스크롤·모션 중심 경험
- **UI/UX & 브랜딩** — Figma 기반 디자인 시스템
- **풀스택 개발** — React / Next.js · Node.js · Supabase
...
포트폴리오 전체는 **[alephstudio.site](https://alephstudio.site/)** 에서 확인할 수 있습니다.

| Project | Category |
|:--------|:---------|
| [Atelier Varga](https://alephstudio.site/ateliervarga.html) | Brand · Editorial Web |
| [Aura & Echo](https://alephstudio.site/auraecho.html) | Interactive · Visual |
| [LOST GARDEN ARCHIVE](https://alephstudio.site/lostgarden.html) | Archive · Experience |
| [SBJ Archive](https://alephstudio.site/sbjarchive.html) | Portfolio · Motion |
| [OBO Design Agency](https://alephstudio.site/obodesign.html) | Agency · Web Design |
...
[![Email](https://img.shields.io/badge/이메일_문의-info@alephstudio.art-000000?style=for-the-badge)](mailto:info@alephstudio.art)
[![Portfolio](https://img.shields.io/badge/포트폴리오_보기-alephstudio.site-111111?style=for-the-badge)](https://alephstudio.site/)
...
*Crafting digital experiences where every element exists for the user.*

**ALEPHSTUDIO** · Seoul · Global
